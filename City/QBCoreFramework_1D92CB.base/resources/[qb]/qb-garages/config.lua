Garages = {
    ...
    ["casinogarage"] = {
        label = "Diamond Casino Parking",
        takeVehicle = vector3(926.25, -21.31, 78.76),
        spawnPoint = vector4(912.23, -34.7, 78.76, 147.48),
        putVehicle = vector3(920.14, -18.75, 78.76),
        isHouse = false,
    },
    ["grovestreetgarage"] = {
        label = "Grove Street Parking",
        takeVehicle = vector3(-61.04, -1826.1, 26.92),
        spawnPoint = vector4(-62.72, -1840.52, 26.68, 312.38),
